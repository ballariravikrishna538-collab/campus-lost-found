import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useAuth, I as ItemType, S as Search, b as Link, B as Bell, a as useBackend, d as useQuery } from "./index-B3kRMkUk.js";
...
function useMatchSuggestions(lostItemId) {
  const { actor, isFetching } = useBackend();
  return useQuery({
    queryKey: ["matchSuggestions", lostItemId == null ? void 0 : lostItemId.toString()],
    queryFn: async () => {
      if (!actor || lostItemId === void 0) return [];
      return actor.getMatchSuggestions(lostItemId);
    },
    enabled: !!actor && !isFetching && lostItemId !== void 0,
    staleTime: 6e4
  });
}
function StatBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: stats.map(({ label, value, icon: Icon, color: color2, bg }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-3.5 h-3.5 ${color2}` })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl leading-none text-foreground", children: value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-medium uppercase tracking-wide", children: label })
          ]
        },
        label
      ))
...
function ActionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to, "data-ocid": ocid, className: "flex-1 group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      whileTap: { scale: 0.96 },
      className: `rounded-2xl p-4 flex flex-col gap-3 ${gradient} shadow-card transition-smooth group-hover:shadow-elevated`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-card/20 backdrop-blur-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 text-card", strokeWidth: 2.5 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-card text-sm leading-tight", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-card/70 text-xs mt-0.5 leading-snug", children: subtitle })
        ] })
      ]
    }
  ) });
...
function HorizontalItemScroll({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ItemCard, { item, index: i + 1, showActions: false }) }, item.id.toString()))
    }
  );
}
function HorizontalSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 overflow-x-hidden pb-2 px-4", children: [1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "flex-shrink-0 w-[280px] h-28 rounded-lg overflow-hidden",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-full" })
    },
    i
  )) });
}
function MatchPair({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl overflow-hidden bg-muted flex-shrink-0", children: item.imageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: item.imageUrl,
              alt: item.name,
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center text-xl", children: isLost ? "🔍" : "📦" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground truncate leading-tight", children: item.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-2.5 h-2.5 text-muted-foreground flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground truncate", children: item.location })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-[10px] px-1.5 py-0.5 rounded font-medium mt-0.5 inline-block ${isLost ? "bg-destructive/15 text-destructive" : "bg-primary/15 text-primary"}`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ItemThumb, { item: lost }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-7 h-7 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { className: "w-3.5 h-3.5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ItemThumb, { item: found })
      ]
    }
  );
}
function HomePage() {
  ...
  const { data: matchItems = [], isLoading: loadingMatches } = useMatchSuggestions(lostItem == null ? void 0 : lostItem.id);
  const matchPairs = lostItem ? matchItems.filter((m) => m.itemType === ItemType.found).map((found) => ({ lost: lostItem, found })) : [];
  const displayName = (currentUser == null ? void 0 : currentUser.name) ? currentUser.name.split(" ")[0] : "there";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": "home.page",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 bg-card border-b border-border px-4 pt-10 pb-4 shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary flex items-center justify-center shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Search,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-base text-foreground leading-tight", children: "Campus Lost & Found" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-2 right-2 w-2 h-2 rounded-full bg-destructive border-2 border-card" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 h-10 rounded-xl bg-muted border border-input text-muted-foreground text-sm cursor-pointer hover:border-primary/50 transition-colors", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Search for lost or found items..." })
              ] })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-5 mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", "data-ocid": "home.action_cards", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ActionCard,
            {
              to: "/report/lost",
        ...
        loadingStats ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2 mx-4 mb-5", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[76px] rounded-lg" }, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatBar,
          {
            lost: (stats == null ? void 0 : stats.lost) ?? 0,
            found: (stats == null ? void 0 : stats.found) ?? 0,
            resolved: (stats == null ? void 0 : stats.resolved) ?? 0
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-6", "data-ocid": "home.recent_listings_section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Recent Listings" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/search",
          ...
          loadingItems ? /* @__PURE__ */ jsxRuntimeExports.jsx(HorizontalSkeleton, {}) : recentItems.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", "data-ocid": "home.listings_empty_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            EmptyState,
            {
              icon: "📭",
              title: "No items yet",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-md bg-primary/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { className: "w-3 h-3 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Smart Matches" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] px-2 py-0.5 rounded-full bg-primary/10 text-primary font-semibold tracking-wide", children: "AI-powered" })
              ] }),
              loadingMatches ? /* @__PURE__ */ jsxRuntimeExports.jsx(HorizontalSkeleton, {}) : matchPairs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", "data-ocid": "home.matches_empty_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                EmptyState,
                {
                  icon: "🔗",
                ...
                "div",
                {
                  ...
                  className: "flex gap-3 overflow-x-auto pb-2 px-4",
                  style: { scrollbarWidth: "none" },
                  children: matchPairs.map((pair, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    MatchPair,
                    {
                      lost: pair.lost,
                      found: pair.found,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-4 mb-6", "data-ocid": "home.browse_section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground mb-3", children: "Browse Items" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-destructive/10 flex items-center justify-center group-hover:bg-destructive/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-5 h-5 text-destructive" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground", children: "Lost Items" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground text-center leading-snug", children: "Browse all reported lost items" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { className: "w-5 h-5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground", children: "Found Items" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground text-center leading-snug", children: "Browse all reported found items" })
                ]
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mb-4 p-3 rounded-xl bg-muted/50 border border-border flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-primary flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground leading-relaxed", children: "Items are visible to all campus members. Always meet in public areas." })
        ] })
      ]
    }
  );
