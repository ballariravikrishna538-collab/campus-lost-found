...
function ReportLostPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (item) => {
      ...
      ue.success("Lost item reported successfully!");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Report Lost Item", showBack: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "px-4 py-5 space-y-5 pb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            id: "name",
            placeholder: "e.g. Black backpack, iPhone 14, Student ID",
            value: form.name,
            onChange: (e) => setForm((f) => ({ ...f, name: e.target.value })),
            className: "h-11",
            "data-ocid": "report_lost.name_input"
          }
        ),
        errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            "data-ocid": "report_lost.name_input.field_error",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            "data-ocid": `report_lost.category_${cat}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            id: "description",
            placeholder: "Describe the item in detail — color, size, markings, brand, any unique features...",
            value: form.description,
            onChange: (e) => setForm((f) => ({ ...f, description: e.target.value })),
            rows: 3,
            "data-ocid": "report_lost.description_input"
          }
        ),
        errors.description && /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            className: "text-xs text-destructive",
            "data-ocid": "report_lost.description_input.field_error",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            ...
            className: "h-11",
            "data-ocid": "report_lost.date_input"
          }
        ),
        errors.date && /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            className: "text-xs text-destructive",
            "data-ocid": "report_lost.date_input.field_error",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              className: "h-11 pl-9",
              "data-ocid": "report_lost.location_input"
            }
          ),
        ...
        errors.location && /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            className: "text-xs text-destructive",
            "data-ocid": "report_lost.location_input.field_error",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            "data-ocid": "report_lost.image_upload_input"
          }
        ),
        imagePreview ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-xl overflow-hidden border border-border bg-muted/30 aspect-video", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "data-ocid": "report_lost.image_remove_button",
          ...
          "button",
          {
            ...
            "data-ocid": "report_lost.upload_button",
            children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          "data-ocid": "report_lost.submit_button",
      ...
      mutation.isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          "data-ocid": "report_lost.loading_state",
          children: "Submitting your report..."
        }
      ),
      mutation.isError && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          "data-ocid": "report_lost.error_state",
